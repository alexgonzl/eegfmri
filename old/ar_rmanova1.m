% adapted for AR task by vc 02/17/10

function [onewayresults] = ar_rmanova1(X,alpha)
...
P1 = 1 - fcdf(F1,v1,v3); %Probability associated with F1
P2 = 1 - fcdf(F2,v2,v3); %Probability associated with F2

onewayresults.C = C;
onewayresults.SST = SST;
onewayresults.dfT = dfT;

onewayresults.SSA = SSA;
onewayresults.v1 = v1;
onewayresults.SSS = SSS;
onewayresults.v2 = v2;
onewayresults.SSE = SSE;
onewayresults.v3 = v3;
onewayresults.MSA = MSA;
onewayresults.MSS = MSS;
onewayresults.MSE = MSE;
onewayresults.F1 = F1;
onewayresults.F2 = F2;
onewayresults.P1 = P1;
onewayresults.P2 = P2;
